    ...
    return (
        ...
        <div className="h-full w-full mt-8 flex flex-col py-5">
            ...
            <div className="w-full h-fit flex flex-col">
                <div className="font-Poppins_sb text-white my-3">Category</div>
               
               

                    <div className="grid grid-cols-4 gap-10">

                      <div className="w-full border-2 bg-none border-slate-400 rounded-md">
                      ...
                      <div className="border-2 bg-none border-slate-400 rounded-md">
